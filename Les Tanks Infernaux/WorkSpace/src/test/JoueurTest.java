...
public class JoueurTest {
	...
	public void testArme() {
		...
		tk1.setArmeSelectionner(0);
		assertTrue(tk1.getArmeSelectionner().equals(armes[0]));
		assertTrue(tk1.getArmeSelectionner().equals(Armes.SIN));
		assertTrue(tk1.getArmeSelectionner().getPath().equals(Armes.SIN.getPath()));
		tk1.setArmeSelectionner(3);
		assertTrue(tk1.getArmeSelectionner().equals(armes[3]));
		assertTrue(tk1.getArmeSelectionner().equals(Armes.ABS));
		assertTrue(tk1.getArmeSelectionner().getPath().equals(Armes.ABS.getPath()));
		tk1.setArmeSelectionner(8);
		assertTrue(tk1.getArmeSelectionner().equals(armes[8]));
		assertTrue(tk1.getArmeSelectionner().equals(Armes.FRAGAIR));
		assertTrue(tk1.getArmeSelectionner().getPath().equals(Armes.FRAGAIR.getPath()));
	}
